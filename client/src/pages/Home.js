                    ...
                    */}
                    <Row>
                        ...
                        <Col className='d-flex flex-column'>
                            ...
                            <ul className='text-left' style={{color: '#5e5e5e'}}>
                                <li>Delayed learners with the assistance of Doodlewrite are able to participate in coloring activities, painting projects or writing assignments.</li>
                    ...
                    <Row>
                        <Col className='d-flex flex-column'>
                            ...
                            <ul className='text-left' style={{color: '#5e5e5e'}}>
                                ...
                                <li>Doodlewrite makes gripping small pencils and crayons easier for tiny hands and helps prevent choking.</li>
                    ...
                    <Row>
                        ...
                        <Col className='d-flex flex-column'>
                            ...
                            <ul className='text-left' style={{color: '#5e5e5e'}}>
                                ...
                                <li>Doodlewrite is a  fun new way to  draw , paint, write, color and learn pre-writing  skills with ease!</li>
                            </ul>
                        </Col>
                    </Row>
                    {/* 
